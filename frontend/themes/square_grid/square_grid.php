...
<?php if (empty($load_more)) :
    $class = array('wplg-gallery-default', 'wplg-gallery', 'wplg-overlay-box-hover');
...
foreach ($attachments as &$attachment) :
    ...
    <div class="wplg-gallery-item"
         style="display: none; width: <?php echo $item_width . ';' ?> padding: <?php echo (int)$params['gutterwidth'] / 2 . 'px' ?> ">
            ...
            <div class="square_thumbnail">
                <div class="img_centered">
                    <img class="wplg-default-thumbnail wplg-gallery-thumbnail <?php echo implode(' ', $class_image_effect) ?>"
                         alt="<?php echo esc_html($attachment->post_title) ?>"
