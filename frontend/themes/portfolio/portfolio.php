...
<?php if (empty($load_more)) : // if load more, don't render div wrap
    $class = array('wplg-gallery-masonry', 'wplg-gallery-portfolio', 'wplg-box-hover', 'wplg-gallery');
...
foreach ($attachments as &$attachment) :
    ...
    <div class="wplg-gallery-item"
         style="padding: <?php echo (int)$params['gutterwidth'] / 2 . 'px' ?> ">
        ...
        <?php if (isset($params['enable_textpanel']) && (int)$params['enable_textpanel'] === 1) : ?>
            <?php if ($attachment->post_title !== '' || $attachment->post_excerpt !== '') : ?>
